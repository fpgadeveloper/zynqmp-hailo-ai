...
The documentation for these example designs is hosted at [ZynqMP Hailo AI design documentation](https://zynqmphailoai.camerafmc.com)
...
only wish to view the documentation, then please view it [here](https://zynqmphailoai.camerafmc.com).
